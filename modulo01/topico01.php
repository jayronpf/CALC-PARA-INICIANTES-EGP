                ...
                <div class="row">
                    ...
                    <div class="col-md-10 col-sm-8 container-fluid">
                        ...
                        <div class="wow fadeIn" data-wow-delay="0.3s">
                            ...
                            <p>
                                <i class="fa-solid fa-arrow-right" style="color: #44833d;"></i>
                                É o arquivo completo, com todas as suas abas ou folhas de cálculo. Na primeira aba,
                                podemos
                                ter, por exemplo, o cálculo de despesas do seu escritório. Na segunda aba as, receitas e
                                na
                                terceira aba, um gráfico demonstrativo.
                            </p>
                            ...
                            <p>
                                ...
                                a
                                baixo, lembrando um plano cartesiano, no qual as coordenadas são representadas pelos
                                pares
                        ...
                        <div class="wow fadeIn" data-wow-delay="0.3s">
                            ...
                            <p>
                                <i class="fa-solid fa-arrow-right" style="color: #44833d;"></i>
                                Elemento básico, primordial em uma planilha. É identificado como sendo a interseção
                                entre
                                dois vetores (retângulo que se forma do cruzamento de linha x coluna). Recebe a
                                informação a
                            ...
                            <p>
                                ...
                                cruzamento da coluna <strong>B</strong> e a linha <strong>2</strong>. Logo, o Calc
                                entende
                                    ...
                                    <div class="zoom">
                                        <a href="..." data-bs-toggle="modal" data-bs-target="#Imagem1">
                                            <img class="wow animate__zoomIn" data delay="0.3s"
                                                src="imgs/index/figura01.png" alt="Imagem que remete a organização"
                                                id="img-1">
                                        </a>
                                    </div>
                        ...
                        <!-- sétimo bloco -->
                        <div class="wow fadeIn" data-wow-delay="0.3s">
                            <h4 class="corsub fw-bolder mt-5">Valores</h4>
                            ...
                            <h4 class="corsub fw-bolder mt-5">Fórmulas</h4>
                            ...
                            <ul class="ul">
                                ...
                                <li><i class="fa-solid fa-cube" style="color: #44833d;"></i> Referência a outras
                                    planilhas
                                    etc.</li>
                            </ul>
                            ...
                            <p>
                                <i class="fa-solid fa-arrow-right" style="color: #44833d;"></i>
                                A fórmula é a parte inteligente da planilha e sem as fórmulas a planilha. Seria somente
                                um
                                amontoado de textos e números.
                            </p>

                            <h4 class="corsub fw-bolder mt-5">Funções</h4>

                            <p class="mt-3">
                                <i class="fa-solid fa-arrow-right" style="color: #44833d;"></i>
                                São fórmulas pré-definidas (nativas) para pouparem tempo e trabalho na criação de uma
                                equação. O Calc contém muitas funções nativas e o usuário é livre para implementar as
                                suas
                        ...
                        <div>
                            ...
                            <p>
                                ...
                                primeira vez, você será solicitado a dar um nome a essa planilha. Encontram-se ainda na
                            ...
                            <p>
                                Localizada abaixo da barra de título, a Barra de menu é composta por vários menus e
                            ...
                            <div>
                                ...
                                <p>
                                    A barra de ferramentas do LibreOffice inclui elementos comuns aos aplicativos, como
