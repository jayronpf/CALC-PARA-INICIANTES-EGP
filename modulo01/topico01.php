            ...
            <div class="main-content container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-10 col-sm-8 container-fluid">
                        ...
                        <!-- Título -->
                        <h2 class="Titulo fw-bolde">Conhecendo a Interface do Calc</h2>
                        <!-- Título -->
                        ...
                        <h3 class="Titulo fw-bolder mt-5 mb-3 subtopico" id="item1">O que é o Calc?</h3>
                        ...
                        <h3 class="Titulo fw-bolder mt-5 mb-3 subtopico" id="item2">Instalação da Suíte LibreOffice</h3>
                        ...
                        <h3 class="Titulo fw-bolder mt-5 mb-3 subtopico" id="item3">Elementos Básicos de Uma Planilha no
                            Calc</h3>
                        ...
                        <!-- 4º Subtopico-->
                        <h3 class="Titulo fw-bolder mt-5 mb-3 subtopico" id="item4">Interface do Calc</h3>
